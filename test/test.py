...
# test case 8
testNewGroupName = "A Better Name"
# test_rename_list(driver, wait, testGroupName, testNewGroupName)
# print("passed test case 8!")

# test case 9
test_partition_list(driver, wait, testNewGroupName, testGroupName)
