...
def test_create_group(driver, wait, name):
    # constant
    dialogTitleXPATH = "//h3[text()='Create A Group']"
    ...
    createButton = wait.until(EC.presence_of_element_located((By.CSS_SELECTOR,".createGroup button")))
    createButton.click()
    ...
    input = wait.until(EC.presence_of_element_located((By.CSS_SELECTOR, "textarea#GroupNameInput")))
    ...
    assert len(wait.until(EC.presence_of_all_elements_located((By.XPATH, "//div[text()='%s']"%name )))) > 0
